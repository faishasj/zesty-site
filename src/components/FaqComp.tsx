function FaqComp() {
	return (
		<div className="flex h-screen w-full items-center justify-center snap-start bg-base-content">
			<div className="flex flex-col items-center w-3/5 text-black">
				<article className="text-4xl mb-12 font-semibold">
